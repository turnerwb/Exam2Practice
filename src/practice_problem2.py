...
def run_test_practice_problem2a():
    ...
    # TEST 1
    expected = [2, 4, 7, 9, 11, 72]
    print("Expected: ", expected)
    print("Actual:   ", practice_problem2a([0, 2, 5, 7, 9, 70], 2))

    # TEST 2
    expected = [0, -6, 44, 33, 75]
    print("Expected: ", expected)
    print("Actual:   ", practice_problem2a([0, -6, 44, 33, 75], 0))

    # TEST 3
    expected = [8, 16, 11, -14, 14]
    print("Expected: ", expected)
    print("Actual:   ", practice_problem2a([2, 10, 5, -20, 8], 6))

    # TEST 3
    expected = [9, 10, 11, 12, 13]
    print("Expected: ", expected)
    print("Actual:   ", practice_problem2a([8, 9, 10, 11, 12], 1))
